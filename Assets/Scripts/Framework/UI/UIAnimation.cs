...
namespace BizzyBeeGames
{
	public class UIAnimation : MonoBehaviour
	{
		...
		private void SetFromValue()
		{
			switch (type)
			{
				...
				case Type.RotationZ:
					...
					break;
				case Type.RotationY:
					fromValue = transform.localEulerAngles.y;
					break;
				case Type.ScaleX:
		...
		private void SetValue(object val)
		{
			switch (type)
			{
				...
				case Type.RotationZ:
					...
					break;
				case Type.RotationY:
					transform.localEulerAngles = new Vector3(transform.localEulerAngles.x, (float)val, transform.localEulerAngles.z);
					break;
				case Type.ScaleX:
		...
		public static UIAnimation RotationY(RectTransform rectT, float from, float to, float duration)
		{
			return CreateAnimation(Type.RotationY, rectT.gameObject, false, from, to, duration);
		}
